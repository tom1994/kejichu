    ...
    <div class="cms-content">
        <div class="cbzz" style="height:650px;">
            ...
            <div class="cbzz-lunbo">
                <div class="stage">
                    <ul class="books-list">
                        <li><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/img/11.jpg"></li>
                        <li><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/img/12.jpg"></li>
                        <li><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/img/13.jpg"></li>
                        <li><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/img/14.jpg"></li>
                    </ul>
                    <div class="desk"></div>
                ...
                <div class="stage">
                    <ul class="books-list">
                        <li><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/img/21.jpg"></li>
                        <li><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/img/22.jpg"></li>
                        <li><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/img/23.jpg"></li>
                        <li><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/img/24.jpg"></li>
                    </ul>
                    <div class="desk"></div>
                    <div class="desk-shadow"></div>
                </div>
