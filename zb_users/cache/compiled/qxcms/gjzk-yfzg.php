<?php  /* Template Name:国家智库下面的依法治国首页 */  ?>
...
<div class="top-content">
    ...
    <div id="div-content" class="top-art">
        <div id="firstPage" class="cms-up show">
            ...
            <a class="gjzl-more" href="<?php  echo $categorys[48]->Url;  ?>">更多</a>
            <ul>
        ...
        <div id="secondPage" class="cms-up hide">
            <h2 class="gjzl-title">内部研究</h2>
            <a class="gjzl-more" href="<?php  echo $categorys[49]->Url;  ?>">更多</a>
            <ul>
        ...
        <div id="thirdPage" class="cms-up hide">
            <h2 class="gjzl-title">内部研究</h2>
            <a class="gjzl-more" href="<?php  echo $categorys[50]->Url;  ?>">更多</a>
            <ul>
                <?php  foreach ( GetList(10, 1) as $key=>$article) { ?>
                <li><a href="<?php  echo $article->Url;  ?>"><?php  echo $article->Title;  ?></a></li>
                <?php }   ?>
...
<div class="cms-content">
    ...
    <div class="cms-left">
        <div class="cms-left-title">
            <h2>研究观点</h2>
            <span><a href="<?php  echo $categorys[51]->Url;  ?>"><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/image/focus.png"></a></span>
        </div>
        <div class="tu-f">
            <!--取得该分类下第一个置顶文章-->
    ...
    <div class="cms-right">
        <div class="cms-right-title">
            <h2>科研成果</h2>
            <span><a href="<?php  echo $categorys[52]->Url;  ?>"><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/image/focus.png"></a></span>
        </div>
        <div class="tu-f">
            <!--取得该分类下第一个置顶文章-->
            <?php  $topArray = GetList(1, 1, null, null, null, null, array("only_ontop"  => true));;  ?>
