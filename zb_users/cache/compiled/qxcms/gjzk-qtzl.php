<?php  /* Template Name:国家智库下面的其他战略首页 */  ?>
...
<div class="top-content">
    ...
    <div class="top-img">
        <div id="KinSlideshow" style="visibility:hidden;">
            <!--取得该分类下加入轮播图的文章-->
            <?php  foreach ( GetList(null,68) as $key=>$article) { ?>
            ...
            <?php }   ?>
            <!--取得该分类下加入轮播图的文章-->
            <?php  foreach ( GetList(null,69) as $key=>$article) { ?>
            <?php if ($article->Metas->lunbo==1) { ?>
            <a href="<?php  echo $article->Url;  ?>" target="_blank"><img src="<?php  echo $article->Metas->pic;  ?>" alt="<?php  echo $article->Title;  ?>"/></a>
            <?php } ?>
            <?php }   ?>
            <!--取得该分类下加入轮播图的文章-->
            <?php  foreach ( GetList(null,70) as $key=>$article) { ?>
            <?php if ($article->Metas->lunbo==1) { ?>
            <a href="<?php  echo $article->Url;  ?>" target="_blank"><img src="<?php  echo $article->Metas->pic;  ?>" alt="<?php  echo $article->Title;  ?>"/></a>
            <?php } ?>
            <?php }   ?>
    ...
    <div id="div-content" class="top-art">
        <div id="firstPage" class="cms-up show">
            ...
            <a class="gjzl-more" href="<?php  echo $categorys[68]->Url;  ?>">更多</a>
            <ul>
                <?php  foreach ( GetList(10, 68) as $key=>$article) { ?>
        ...
        <div id="secondPage" class="cms-up hide">
            <h2 class="gjzl-title">内部研究</h2>
            <a class="gjzl-more" href="<?php  echo $categorys[69]->Url;  ?>">更多</a>
            <ul>
                <?php  foreach ( GetList(10, 69) as $key=>$article) { ?>
                <li><a href="<?php  echo $article->Url;  ?>"><?php  echo $article->Title;  ?></a></li>
                <?php }   ?>
            </ul>
        </div>
        <div id="thirdPage" class="cms-up hide">
            <h2 class="gjzl-title">内部研究</h2>
            <a class="gjzl-more" href="<?php  echo $categorys[70]->Url;  ?>">更多</a>
            <ul>
                <?php  foreach ( GetList(10, 70) as $key=>$article) { ?>
                <li><a href="<?php  echo $article->Url;  ?>"><?php  echo $article->Title;  ?></a></li>
                <?php }   ?>
            </ul>
        </div>
...
<div class="cms-content">
    ...
    <div class="cms-left">
        <div class="cms-left-title">
            <h2>研究观点</h2>
            <span><a href="<?php  echo $categorys[71]->Url;  ?>"><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/image/focus.png"></a></span>
        </div>
        <div class="tu-f">
            <!--取得该分类下第一个置顶文章-->
            <?php  $topArray = GetList(1, 71, null, null, null, null, array("only_ontop"  => true));;  ?>
        ...
        <div class="cms-lr-list">
            <ul>
                <?php  foreach ( GetList(4,71) as $key=>$article) { ?>
                <li><a href="<?php  echo $article->Url;  ?>"><?php  echo $article->Title;  ?></a></li>
                <?php }   ?>
            </ul>
        </div>
    ...
    <div class="cms-right">
        <div class="cms-right-title">
            <h2>科研成果</h2>
            <span><a href="<?php  echo $categorys[72]->Url;  ?>"><img src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/image/focus.png"></a></span>
        </div>
        <div class="tu-f">
            <!--取得该分类下第一个置顶文章-->
            <?php  $topArray = GetList(1, 72, null, null, null, null, array("only_ontop"  => true));;  ?>
            <?php  foreach ( $topArray as $top) { ?>
            <a href="<?php  echo $top->Url;  ?>"><img src="<?php  echo $top->Metas->pic;  ?>" alt="<?php  echo $top->Title;  ?>">
                <h3><?php  echo $top->Title;  ?></h3>
            </a>
        ...
        <div class="cms-lr-list">
            <ul>
                <?php  foreach ( GetList(4,72) as $key=>$article) { ?>
                <li><a href="<?php  echo $article->Url;  ?>"><?php  echo $article->Title;  ?></a></li>
                <?php }   ?>
            </ul>
        </div>
