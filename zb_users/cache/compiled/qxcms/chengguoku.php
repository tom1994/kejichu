...
<div class="top-content">
    ...
    <style type="text/css">
        ...
        ul.tree li .collapsed {
            background-image: url(<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/images/collapsed.gif);
        }

        ul.tree li .expanded {
            background-image: url(<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/images/expanded.gif);
        }
        ...
        ul.tree li .checkbox {
            ...
            cursor: pointer;
            float: left;
            background: url(<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/images/check0.gif) no-repeat 0 0px;
        }

        ul.tree li .checked {
            background-image: url(<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/images/check2.gif);
        }
    ...
    <div style="">
        <form name="search-chengguoku" method="post" action="<?php  echo $host;  ?>zb_system/cmd.php?act=search">
...
<!--                                        </li>-->
    ...
    <script type="text/javascript" src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/js/jquery.checktree.js"></script>
    <script>
        $(function () {
            $('ul.tree').checkTree();
        });
